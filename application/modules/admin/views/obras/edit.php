        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            <form role="form" action="{base_url}admin/obras/add" method="post" enctype='multipart/form-data'>
              ...
              <div class="form-group ">
                <label for="exampleInputFile">Imagem da Obra</label>
                <input onchange="loadFile(event)" type="file" name="url_image_obra">
                <p class="help-block"></p>
                <div style="display: flex; justify-content: center;align-items: center;"><img class="img-responsive" src="http://www.napoliimoveis.com.br/sites/1/1/site/_layout/site/imagens/inicio-no-img.jpg" style="height: 300px" id="output"/></div>
